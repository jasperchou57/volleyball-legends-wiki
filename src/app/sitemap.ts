...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/codes/expired`, lastModified: now, changeFrequency: "weekly", priority: 0.72 },
    { url: `${base}/haikyuu-legends-codes`, lastModified: now, changeFrequency: "daily", priority: 0.82 },
    { url: `${base}/patch-diff`, lastModified: now, changeFrequency: "weekly", priority: 0.88 },
    { url: `${base}/trading`, lastModified: now, changeFrequency: "weekly", priority: 0.86 },
    { url: `${base}/next-update`, lastModified: now, changeFrequency: "daily", priority: 0.82 },
    ...
    { url: `${base}/tools/spin-budget`, lastModified: now, changeFrequency: "weekly", priority: 0.78 },
